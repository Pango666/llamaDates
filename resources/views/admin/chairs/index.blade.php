@extends('layouts.app')
@section('title', 'Gestión de Sillas')
  ...
  <div class="max-w-6xl mx-auto">
    ...
    <div class="card mb-6">
      <div class="border-b border-slate-200 pb-4">
        ...
        <p class="text-sm text-slate-600 mt-1">Administre las sillas odontológicas y sus turnos de trabajo.</p>
      </div>
    </div>
      ...
      <div class="grid gap-4 md:grid-cols-5 md:items-end">
        <div class="md:col-span-3 space-y-2">
          ...
          <input 
            ...
            placeholder="Nombre o turno de la silla..."
          >
        </div>
    ...
    <div class="card p-0 overflow-hidden">
                  ...
                  <td class="px-4 py-3">
                    <div class="flex items-center justify-end gap-2">
                      ...
                      <form 
                        ...
                        class="inline"
                        onsubmit="return confirm('¿Está seguro de eliminar esta silla? Esta acción no se puede deshacer.')"
                      >
                        @csrf @method('DELETE')
                        <button 
      ...
      @else
        ...
        <div class="text-center py-12">
          ...
          <h3 class="text-lg font-medium text-slate-700 mb-2">No hay sillas registradas</h3>
          <p class="text-slate-500 mb-6">Comience agregando la primera silla odontológica.</p>
          <a 
