...
@section('header-actions')
  <a href="{{ route('admin.patients.consents.index',$consent->patient_id) }}" class="btn bg-slate-600 text-white hover:bg-slate-700 flex items-center gap-2 transition-colors">
