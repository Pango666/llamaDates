...
@section('header-actions')
    <div class="flex items-center gap-3">
        <a href="{{ route('admin.dentists') }}" class="btn bg-slate-600 text-white hover:bg-slate-700 flex items-center gap-2 transition-colors">
...
<style>
    ...
    .appointment-status { padding:2px 8px; border-radius:12px; font-size:.7rem; font-weight:500; }
    ...
    <div class="flex flex-col lg:flex-row items-start lg:items-center gap-6">
        ...
        <div class="flex-1">
            ...
            <div class="flex flex-wrap items-center gap-4">
                @if($dentist->ci)
                    <div class="flex items-center gap-2 text-slate-600 bg-slate-100 px-3 py-1 rounded-full">
                        <svg class="w-4 h-4 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                        <span class="font-medium">CI: {{ $dentist->ci }}</span>
                    </div>
                @endif
...
<div class="grid gap-6 lg:grid-cols-3">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                ...
                <div>
                    ...
                    <p class="text-slate-800 font-mono">{{ $dentist->ci }}</p>
                </div>
            </div>
            @endif
            ...
            <div class="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                ...
                <div>
                    ...
                    <p class="text-slate-800">{{ $dentist->address }}</p>
                </div>
            </div>
            @endif
            ...
            <div class="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                ...
                <div>
                    ...
                    <p class="text-slate-800">{{ $dentist->user->phone ?? '—' }}</p>
                </div>
            </div>
    ...
    <section class="card lg:col-span-2">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="text-xs text-slate-500">Ordenadas por fecha y hora (más recientes primero)</div>
        </div>
        <div class="flex items-center justify-between mb-2">
            <span class="text-sm text-slate-500">{{ $upcoming->total() }} programadas</span>
        </div>
        ...
        <div class="mt-4 flex items-center justify-between">
            <div class="text-sm text-slate-600">
                Mostrando {{ $upcoming->firstItem() ?? 0 }} - {{ $upcoming->lastItem() ?? 0 }} de {{ $upcoming->total() }} citas
            </div>
...
<div class="card mt-6">
  @include('admin.partials._audit_trail', ['model' => $dentist])
</div>
@endsection
