  ...
  <div class="max-w-6xl mx-auto">
    ...
    <div class="card mb-6">
      <div class="border-b border-slate-200 pb-4">
        ...
        <p class="text-sm text-slate-600 mt-1">Administre los permisos del sistema y sus asignaciones a roles.</p>
      </div>
    </div>
                  ...
                  <td class="px-4 py-3">
                    <div class="flex items-center justify-end gap-2">
                      ...
                      <form 
                        ...
                        class="inline"
                        onsubmit="return confirm('¿Está seguro de eliminar este permiso? Esta acción podría afectar los roles asignados.')"
                      >
                        @csrf @method('delete')
                        <button 
