      ...
      <div class="border-b border-slate-200 pb-4 mb-6">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-2 text-sm text-slate-500">
            ...
            <span class="bg-{{ $service->active ? 'green' : 'red' }}-100 text-{{ $service->active ? 'green' : 'red' }}-800 px-2 py-1 rounded">
        ...
        <div class="flex items-start gap-3">
          ...
          <div>
            ...
            <ul class="text-sm text-amber-700 mt-2 space-y-1">
              ...
              <li>• El cambio de precio no afectará citas ya facturadas</li>
              <li>• Desactivar el servicio impedirá nuevas asignaciones</li>
            </ul>
          </div>
        </div>
      </div>
