  ...
  <div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            @unless($isLocked)
            <div id="registrar-cobro" class="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
                ...
                <div class="relative border-l-2 border-slate-100 ml-2 space-y-6">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-xs text-slate-400 font-medium">Pagado: {{ $payment->paid_at ? $payment->paid_at->format('d/m/Y') : $payment->created_at->format('d/m/Y') }} | Reg: {{ $payment->created_at->format('d/m/Y H:i') }}</span>
                        </div>
